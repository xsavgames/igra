...
Yanfly.Param.BCEList = {
      ...
      equal: Number(Yanfly.Parameters['Key =']),
          ...
          q: Number(Yanfly.Parameters['Key Q']),
          w: Number(Yanfly.Parameters['Key W']),
          e: Number(Yanfly.Parameters['Key E (OK)']),
  ...
  backSlash: Number(Yanfly.Parameters['Key \\']),
          ...
          l: Number(Yanfly.Parameters['Key L (PageDown)']),
  semicolon: Number(Yanfly.Parameters['Key ;(PageUp)']),
...
Input._revertButton = function(button) {
  if (button === 'OK') {
    ...
    this.keyMapper[186] = 'pageup';
  } else if (button === 'PAGEDOWN') {
    this.keyMapper[34] = 'pagedown';
    this.keyMapper[76] = 'pagedown';
  } else if (button === 'LEFT') {
...
Input._switchButton = function(button) {
  if (button === 'OK') {
    ...
    if (Yanfly.Param.BCEList['e'] !== 0) this.keyMapper[69] = 'e';
